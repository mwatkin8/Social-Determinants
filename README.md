...
The app uses npm to serve the needed files. Use [this page](https://www.npmjs.com/get-npm) to install npm if you do not have it installed. After installation, run <code>npm install</code> in the home directory of this repo , then run <code>npm start</code>.
...
## 3. Perform a SMART launch from your sandbox
Select the "Apps" option on the sidebar
